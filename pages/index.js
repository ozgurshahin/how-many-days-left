    ...
    const handleKeyDown = (e, id) => {
        ...
        if (["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(e.key)) {
            setPositions((prev) => {
                ...
                switch (e.key) {
                    case "ArrowUp":    return { ...prev, [id]: { ...current, y: current.y - step } };
                    case "ArrowDown":  return { ...prev, [id]: { ...current, y: current.y + step } };
                    case "ArrowLeft":  return { ...prev, [id]: { ...current, x: current.x - step } };
                    case "ArrowRight": return { ...prev, [id]: { ...current, x: current.x + step } };
                    default: return prev;
                }
            });
        }
            ...
            {countdownData.map((item, index) => {
                ...
                return (
                    <div
                        ...
                        onTouchMove={handleTouchMove}
                        onTouchEnd={handleTouchEnd}
                        onFocus={(e) => { e.currentTarget.style.boxShadow = "0 0 0 3px rgba(0,0,0,0.25)"; }}
                        onBlur={(e) => { e.currentTarget.style.boxShadow = "0 6px 12px rgba(0,0,0,0.12)"; }}
                        style={baseCardStyle}
                    >
                        <h2
                            style={{
